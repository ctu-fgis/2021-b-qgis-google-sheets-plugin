...
class GoogleSheetsDownloader2:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GoogleSheetsDownloader2_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Google Sheets Downloader 2')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'GoogleSheetsDownloader2')
        self.toolbar.setObjectName(u'GoogleSheetsDownloader2')

        #print "** INITIALIZING GoogleSheetsDownloader2"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GoogleSheetsDownloader2', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/google_sheets_downloader2/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Google Sheets Downloader 2'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Google Sheets Downloader 2'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = GoogleSheetsDownloader2DockWidget()
