...
latex_documents = [
  ('index', 'GoogleSheetsDownloader2.tex', u'GoogleSheetsDownloader2 Documentation',
   u'Group B - FGIS 2021', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'GoogleSheetsDownloader2 Documentation',
     [u'Group B - FGIS 2021'], 1)
]
